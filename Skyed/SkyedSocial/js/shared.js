// ── DATOS ──────────────────────────────────────────────
const events = [
  {id:1,cat:'bodas',title:'Boda en jardín',emoji:'💐',bg:'img-p-wedding',guests:120,hours:8,price:'$18.500.000',tag:'BODA',desc:'Ceremonia al aire libre con arco floral, banquete de 5 tiempos y pista de baile iluminada entre jardines.',includes:['Arco floral natural','Banquete 5 tiempos','DJ toda la noche','Fotografía profesional','Decoración mesas','Iluminación ambiental','Coordinador en sitio','Pastel nupcial']},
...
function updateCarousel(index, direction) {
  ...
  setTimeout(() => {
    ...
    document.getElementById('heroBadge').textContent = s.badge;
