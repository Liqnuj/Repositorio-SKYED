...
<body>
  <header class="site-header" role="banner">
    <nav class="nav" aria-label="Navegación principal">
      <a  class="brand"><img src="img/logo_deportivo.png" alt="" /><span>SKY<em>ED</em></span></a>
  ...
  <main id="main" class="auth-wrapper">
    ...
    <section class="auth-form-box">
      <form class="auth-form" id="recover-form" action="php/enviar_codigo_.php" method="POST">
        <div id="step1">
          <h1>Olvidé mi contraseña</h1>
          <p class="lead">Ingresa el correo asociado a tu cuenta y te enviaremos un código.</p>

          <div class="form-group">
            <label for="email">Correo electrónico <span class="req">*</span></label>
            <input id="email" name="email" type="email" required maxlength="80"
                   data-validate="email" placeholder="tucorreo@ejemplo.com" autocomplete="email" />
